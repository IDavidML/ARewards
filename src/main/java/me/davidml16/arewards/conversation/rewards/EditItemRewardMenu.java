...
public class EditItemRewardMenu implements ConversationAbandonedListener, CommonPrompts {

    private Main main;
    public EditItemRewardMenu(Main main) {
        this.main = main;
    }
    ...
    public class RewardMenuOptions extends FixedSetPrompt {
        ...
        protected Prompt acceptValidatedInput(ConversationContext param1ConversationContext, String param1String) {
            ...
            switch (param1String) {
                case "1":
                    return new CommonPrompts.UncoloredStringPrompt(main, this, true, ChatColor.YELLOW + "  Edit reward name, \"cancel\" to return.\n\n ", "rewardName");
                case "2":
